...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=dmitryshcherbakov.grpc.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1d, 0x64, 0x6d, 0x69, 0x74, 0x72, 0x79, 0x73,
	0x68, 0x63, 0x68, 0x65, 0x72, 0x62, 0x61, 0x6b, 0x6f, 0x76, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e,
	0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8, 0x01, 0x0a,
	0x07, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x45, 0x0a, 0x06, 0x64, 0x72, 0x69, 0x76,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2d, 0x2e, 0x64, 0x6d, 0x69, 0x74, 0x72,
	...
	0x3d, 0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x25, 0x2e, 0x64, 0x6d, 0x69, 0x74, 0x72, 0x79, 0x73, 0x68, 0x63, 0x68, 0x65, 0x72, 0x62, 0x61,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: dmitryshcherbakov.grpc.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: dmitryshcherbakov.grpc.pcbook.Storage
	(*Memory)(nil),      // 2: dmitryshcherbakov.grpc.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: dmitryshcherbakov.grpc.pcbook.Storage.driver:type_name -> dmitryshcherbakov.grpc.pcbook.Storage.Driver
	2, // 1: dmitryshcherbakov.grpc.pcbook.Storage.memory:type_name -> dmitryshcherbakov.grpc.pcbook.Memory
